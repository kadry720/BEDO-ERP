...
on_session_creation = "bedo_platform.services.auth_service.enforce_database_session"
...
auth_hooks = ["bedo_platform.services.auth_service.database_request_auth_hook"]
